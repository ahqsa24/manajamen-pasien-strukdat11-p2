...
void tambahPasien() {
    ...
    cout << "Tambahkan fungsi untuk menambahkan pasien di sini" << endl;
}

// Tambahkan opsi menu baru di dalam viewMenuLogin() untuk menambahkan pasien
void viewMenuLogin() {
    while (true) {
        string pilihan;
        cout << "\n== MENU ADMIN ==" << endl;
        ...
        cout << "4. Tambah Pasien" << endl; // Opsi baru untuk menambah pasien
        cout << "5. Logout" << endl;
        ...
        if (pilihan == "1") {
            ...
            tambahPasien(); // Panggil fungsi tambahPasien di sini
        } else if (pilihan == "5") {
